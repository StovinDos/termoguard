...
const PRODUCTS = [
  ...
  { id: 2, name: 'TermoGuard Pro',    tagline: 'Professional Grade',    price: 119.99, originalPrice: 149.99, badge: 'Most Popular', badgeColor: 'bg-neon-amber text-void',                                                 rating: 4.95,reviews: 832,  description: 'Advanced sensor array for workshops, server rooms, and small facilities. Supports 10 monitoring zones.', features: ['10 Zones', 'SMS + Email Alerts', 'API Access', 'Data Export'], color: 'amber',     accentHex: '#ffb700' },
  { id: 3, name: 'TermoGuard Mesh',   tagline: 'Multi-Sensor Network',  price: 199.99, originalPrice: null,   badge: 'New',          badgeColor: 'bg-neon-green text-void',                                                 rating: 4.8, reviews: 214,  description: 'Deploy a network of 5 synchronized sensors. Ideal for warehouses, gyms, and multi-room monitoring.',      features: ['5 Sensors', 'Mesh Networking', 'Dashboard', '3-Year Warranty'],   color: 'green',     accentHex: '#39ff14' },
  { id: 4, name: 'TermoGuard Shield', tagline: 'Industrial Protection', price: 299.99, originalPrice: null,   badge: 'Industrial',   badgeColor: 'bg-ink-secondary/20 text-ink-secondary border border-ink-secondary/30', rating: 5.0, reviews: 89,   description: 'Ruggedized for harsh environments. IP67 rated, -40° to +125°C range, with 4G LTE backup connectivity.',    features: ['IP67 Rated', '-40° to 125°C', '4G LTE Backup', 'SCADA Integration'], color: 'secondary', accentHex: '#7a9abf' },
];
    ...
    <div className="relative">
      ...
      {open && (
        <motion.div
          ...
          exit={{ opacity: 0, y: -8 }}
          className="absolute right-0 top-full mt-2 z-50 glass border border-[rgba(0,245,212,0.2)] min-w-[180px]"
        >
          {Object.entries(currencies).map(([code, { label }]) => (
            <button
              key={code}
              onClick={() => { setCurrency(code); setOpen(false); }}
              className={`w-full text-left px-4 py-2.5 font-mono text-xs tracking-wide hover:bg-cyan/10 hover:text-cyan transition-colors
